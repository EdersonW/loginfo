...
class ProductsTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ->requirePresence('product_perishable', 'create')
            ->notEmptyString('product_perishable');

        $validator
            ->date('date_validate')
            ->allowEmptyDate('date_validate');

        $validator
            ->date('date_manufacturing')
            ->notEmptyDate('date_manufacturing');
